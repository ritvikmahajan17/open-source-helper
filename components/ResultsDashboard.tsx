...
const LanguageUsageList: React.FC<{ languages: LanguageUsage[] }> = ({
  languages,
}) => (
...
const TopContributorsList: React.FC<{ contributors: Contributor[] }> = ({
  contributors,
}) => (
...
const HowToContribute: React.FC<{ guidelines: string[] }> = ({
  guidelines,
}) => (
  <div>
    <ul className="space-y-3">
